...
public class TabelStockController {
    ...
    @FXML
    void initialize() {
        TableColumn<Stock, Integer> id = new TableColumn<Stock, Integer>("id");
        TableColumn<Stock, String> title = new TableColumn<Stock, String>("Название");
        TableColumn<Stock, Integer> price = new TableColumn<Stock, Integer>("Цена");
        TableColumn<Stock, String> stockCategories = new TableColumn<Stock, String>("Категория");
        TableColumn<Stock, Integer> count = new TableColumn<Stock, Integer>("Кол-во");
        TableStock.getColumns().add(id);
        TableStock.getColumns().add(title);
        TableStock.getColumns().add(price);
        TableStock.getColumns().add(stockCategories);
        TableStock.getColumns().add(count);
