...
import DBConnector.DataBaseHandlerProduct;
...
public class EditProduct {
    ...
    public void editstock(){
        ...
        dataBaseHandlerProduct.EditStock(newId, newTitle, newPrice, newStockCategories, newCount);
    }
    public void setStockData(Product selectedItem) {
