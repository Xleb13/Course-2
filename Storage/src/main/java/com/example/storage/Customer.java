...
public class Customer {
    ...
    @FXML
    private TableColumn<?, ?> DateOfBirthdayCustomer;

    @FXML
    private TableColumn<?, ?> EmailCustomer;

    @FXML
    private TableColumn<?, ?> GenderCustomer;
    ...
    @FXML
    private TableColumn<?, ?> PaymetDetailCustomer;

    @FXML
    private TableColumn<?, ?> PhoneNumberCustomer;
